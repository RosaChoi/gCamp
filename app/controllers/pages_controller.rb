class PagesController < ApplicationController
  ...
  def faq
    ...
    faq2 = Faq.new('How do I join gCamp?','Right now, gCamp is still in production. So, there is not a sign up page open to the public, yet! Your best opetion is to become super best friends with a gCamp developer. They can be found in the hanging around gSchool during the day and hitting the hottest clubs at night.')
